...
while i < 10:
    if os.path.exists('ns_b_output.json') == True:
        f = open('ns_b_output.json')
...
i = 0
while i < 10:
    if os.path.exists('ns_a_output.json') == True:
        f = open('ns_a_output.json')
        
        json_data = json.load(f)

        print ("{:<10} | {:<21} |".format('Ingress', 'AB_ETH'))
...
i=0
while i < 10:
    if os.path.exists('ns_c_output.json') == True:
        f = open('ns_c_output.json')
